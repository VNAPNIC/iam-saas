            ...
            <div className="card bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <Link href="/forgot-password" className="text-sm text-blue-500 hover:text-blue-700">{t('login.forgotPassword')}</Link>
                    </div>
                ...
                <p className="text-sm text-center mt-4 text-gray-600">
                    {t('login.noAccount')} <Link href="/signup" className="text-blue-500 hover:text-blue-700">{t('login.signUpLink')}</Link>
                </p>
            </div>
