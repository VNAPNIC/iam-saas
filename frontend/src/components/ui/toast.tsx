...
// Simple toast replacements to avoid createContext issues
const ToastPrimitives = {
  ...
  Action: React.forwardRef<HTMLButtonElement, any>(({ className, ...props }, ref) => (
    <button ref={ref} className={className} {...props} />
  )),
  Close: React.forwardRef<HTMLButtonElement, any>(({ className, ...props }, ref) => (
    <button ref={ref} className={className} {...props} />
  )),
  Title: React.forwardRef<HTMLDivElement, any>(({ className, ...props }, ref) => (
    <div ref={ref} className={className} {...props} />
  )),
  Description: React.forwardRef<HTMLDivElement, any>(({ className, ...props }, ref) => (
    <div ref={ref} className={className} {...props} />
  ))
};
